...
_ANALISTA_COMMON = (
    ...
    "No inventes normas: cita artículos SOLO si están en el bloque de "
    "basamento legal recuperado o en el cuestionario inyectado. Si falta el "
    "texto, marca fundamento pendiente y no fabriques numeración.\n"
...
_ANALISTA_CA_APERTURA_UNICA = (
    ...
    "basamento recuperado o en el cuestionario inyectado. Si no está, no "
    "inventes citas (fundamento pendiente).\n\n"
    ...
    "corresponda). En hallazgos incluye: código, texto de la pregunta, "
    "fundamento legal (artículos vulnerados + cita textual del extracto "
    "inyectado), rango de criticidad, acción legal y advertencia gerencial. "
    "Si falta un campo del cuestionario, déjalo vacío; si el artículo no está "
    "en el basamento recuperado, fundamento pendiente.\n\n"
    ...
    "explicación; checklist de puntos: aciertos con cumplimiento breve; "
    "hallazgos con no conformidad, fundamento legal citado (extracto) y "
    "recomendación de subsanación. Evita revelar agentes internos: habla como "
...
_JURIDICO_COMMON = (
    ...
    "priorizadas. Cita normas SOLO si están en el basamento recuperado o en los "
    "hallazgos ya emitidos; si falta el texto, fundamento pendiente. No inventes "
    "hechos ni numeración de artículos.\n"
...
_JURIDICO_CA_APERTURA_UNICA = (
    ...
    "- NO inventes citas legales si el artículo no está en el basamento "
    "recuperado ni en los hallazgos; si el modelo pide LOPA/RLCP/LOCGR y no "
    "hay texto normativo inyectado, fundamenta con lo disponible y marca "
    "fundamento pendiente cuando falte la cita textual.\n\n"
    ...
    "si hay riesgo patrimonial, citando el extracto del basamento o "
    "marcando fundamento pendiente)\n\n"
...
_JURIDICO_CONTRATACION_DIRECTA = (
    ...
    "citando el extracto del basamento o marcando fundamento pendiente)\n\n"
    "Lenguaje: jurídico, técnico, neutral, sin ambigüedades.\n"
)
